    ...
    return
      ...
      child: Card(
        ...
        Row(crossAxisAlignment: CrossAxisAlignment.start,
          ...
          children: [
            Expanded(child: Text(this.widget.item.name,style: TextStyle(fontWeight: FontWeight.w900),)),
        ...
        Row(crossAxisAlignment: CrossAxisAlignment.start,
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Expanded(child: Text((this.widget.item.registrationId!=null&&this.widget.item.registrationId!=""?this.widget.item.registrationId:this.widget.item.id.key),style: TextStyle(fontWeight: FontWeight.w300),),),
