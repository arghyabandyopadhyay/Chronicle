...
import 'package:chronicle/Pages/TutorPages/CoursesByMePages/edit_video_page.dart';
import 'package:chronicle/Widgets/video_card_widget.dart';
...
class _VideoListState extends State<VideoList> {
  ...
  updateVideoDetails(VideoIndexModel videoIndexModel, int index) {
    ...
    globalShowInSnackBar(widget.scaffoldMessengerKey,
        "Video Renamed to ${videoIndexModel.name}!!");
  }
                  ...
                  return Slidable(
                    ...
                    secondaryActions: <Widget>[
                      ...
                      IconSlideAction(
                        ...
                        onTap: () async {
                          setState(() {
                            deleteFromStorageModule(displayList[index],
