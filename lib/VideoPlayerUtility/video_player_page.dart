...
import 'package:chronicle/Widgets/doubt_list.dart';
...
class _VideoPlayerPageState extends State<VideoPlayerPage> {
  ...
  Future<void> initializePlayer() async {
    _videoPlayerController1 =
        VideoPlayerController.network(widget.video.downloadUrl);
    await Future.wait([
      ...
      child: Scaffold(
        ...
        body: Column(
          children: <Widget>[
            ...
            if (widget.isDoubtEnabled)
              SizedBox(
                height: 5,
              ),
            if (widget.video.doubts != null && widget.isDoubtEnabled)
              Center(
                child: Text(
                  "Doubts",
            ...
            if (widget.video.doubts != null && widget.isDoubtEnabled)
              Container(
                ...
                child: DoubtList(
                  ...
                  listItems: widget.video.doubts,
                  scaffoldMessengerKey: scaffoldMessengerKey,
                  scrollController: scrollController,
                  textEditingController: textController,
                ),
              ),
            if (!widget.isTutor && widget.isDoubtEnabled)
              Row(children: [
                CircleAvatar(
                  radius: 25,
                  child: Image.asset(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          suffix: IconButton(
                            ...
                            onPressed: () {
                              setState(() {
                                if (doubtTextField.text.isNotEmpty)
                                  widget.video.addDoubtToVideo(DoubtModel(
                                      userName: GlobalClass.user.displayName,
                                      question: doubtTextField.text,
                                      answer: null));
                              });
                            },
                          ),
