...
import 'package:chronicle/OwnerModules/owner_module.dart';
import 'package:chronicle/Modules/universal_module.dart';
import 'package:chronicle/OwnerModules/chronicle_users_list.dart';
...
import 'owner_database_module.dart';
...
class _ClientAccessEditPageState extends State<ClientAccessEditPage> {
  ...
  void searchOperation(String searchText) {
    ...
    if (_isSearching) {
      searchResult = clients
          .where((ChronicleUserModel element) =>
  ...
  void registerClientUsingToken(String uid) async {
    ...
    if (userDetails != null) {
      ChronicleUserModel chronicleUserModel = new ChronicleUserModel(
          uid: uid,
      ...
      globalShowInSnackBar(scaffoldMessengerKey, "No Such user found!!");
  }
  ...
  synchronizeCloudStorageSizes() async {
    ...
    setState(() {
      globalShowInSnackBar(
          scaffoldMessengerKey, "Cloud Occupied data synchronized");
    });
  }
            ...
            PopupMenuButton<ModalOptionModel>(
              itemBuilder: (BuildContext popupContext) {
                return [
                              ...
                              return OptionModalBottomSheet(
                                  ...
                                  list: [
                                    ModalOptionModel(
                                      ...
                                      onTap: () {
                                        setState(() {
                                          clients = sortChronicleUsersModule(
                                              "A-Z", clients);
                                        });
                  ...
                  ModalOptionModel(
                      particulars: "Sync Cloud Occupied Data",
                      icon: Icons.sync,
                      onTap: () async {
                        Navigator.pop(popupContext);
        ...
        body: this.clients != null
            ? this.clients.length == 0
                ...
                : Column(children: <Widget>[
                    Expanded(
                        child: ChronicleUsersList(
                            _isSearching ? this.searchResult : this.clients,
                            () {
