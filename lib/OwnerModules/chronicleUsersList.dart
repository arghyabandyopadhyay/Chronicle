    ...
    return RefreshIndicator(
      ...
      itemBuilder: (context, index) {
        return InkWell(
          ...
          child: Card(
            color: this.widget.listItems[index].cloudStorageSize<this.widget.listItems[index].cloudStorageSizeLimit?Colors.transparent:Colors.red.withOpacity(0.5),
            elevation: 0,
                ...
                children: [
                  Expanded(child: Column(
                    ...
                    children: [
                      ...
                      Text("${classifySize(this.widget.listItems[index].cloudStorageSize)} of ${classifySize(this.widget.listItems[index].cloudStorageSize)}",style: TextStyle(fontWeight: FontWeight.w300),),
                    ],)),
