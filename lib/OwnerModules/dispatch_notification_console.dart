...
import 'owner_module.dart';

class DispatchNotificationConsole extends StatefulWidget {
  DispatchNotificationConsole({Key key}) : super(key: key);
  @override
  _DispatchNotificationConsoleState createState() =>
      _DispatchNotificationConsoleState();
}

class _DispatchNotificationConsoleState
    extends State<DispatchNotificationConsole> {
            ...
            onPressed: () async {
              ...
              setState(() {
                sendNotificationsToAll(
                    scaffoldMessengerKey, GlobalClass.userDetail.messageString,
                    (String updateText) {
                  setState(() {
                    consoleTextController.text =
                        consoleTextController.text + "\n" + updateText;
                  });
                }).then((value) async => {
                      ...
                      globalShowInSnackBar(scaffoldMessengerKey,
                          "All notifications have been dispatched."),
