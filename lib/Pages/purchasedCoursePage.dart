...
import 'package:chronicle/Pages/TutorPages/CoursesByMePages/edit_course_page.dart';
import 'package:chronicle/VideoPlayerUtility/video_player_page.dart';
import 'package:chronicle/Widgets/loader_widget.dart';
import 'package:chronicle/Widgets/course_home_page_video_list.dart';
...
class PurchaseCoursePage extends StatefulWidget {
  ...
  final bool isTutor;
  const PurchaseCoursePage({Key key, this.course, this.isTutor})
      : super(key: key);
  @override
