          ...
          if (!_isLoading) {
            ...
            if (GlobalClass.myCourses == null)
              return getAllCourseIndexes("Wishlist", false).then((courses) {
                if (mounted)
                  this.setState(() {
                    ...
                    wishlist = GlobalClass.myCourses
                        .where((element) => element.courseStatus == "Wishlist")
                        .toList();
                    _counter++;
                    _isLoading = false;
                    this.appBarTitle = Text("Wishlist");
              ...
              return this.setState(() {
                this.wishlist = GlobalClass.myCourses
                    .where((element) => element.courseStatus == "Wishlist")
                    .toList();
                _counter++;
                _isLoading = false;
            ...
            onPressed: () {
              Navigator.of(context).push(CupertinoPageRoute(
                  builder: (checkoutPageContext) => CheckoutPage(
                        courses: this.wishlist,
                        isFromPreviewPage: false,
                      )));
            },
            label: Text("Checkout"),
