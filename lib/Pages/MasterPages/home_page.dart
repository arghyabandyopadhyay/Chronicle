            ...
            return getAllCourseIndexes("Courses", false).then((courses) {
              if (mounted)
                this.setState(() {
                  ...
                  purchasedCourses = GlobalClass.myCourses
                      .where((element) => element.courseStatus == "Courses")
                      .toList();
                  _counter++;
                  _isLoading = false;
                  this.appBarTitle =
                  ...
                  onPressed: () async {
                    Navigator.of(widget.mainScreenContext).push(
                        new CupertinoPageRoute(
                            builder: (qrCodePageContext) => WishlistPage()));
                  }),
            ],
          ),
          body: Column(
              ...
              if (GlobalClass.userDetail.isAppRegistered == 1)
                ListTile(
                  onTap: () {
                    Navigator.of(widget.mainScreenContext).push(
                        CupertinoPageRoute(
                            builder: (context) => VideosPage(false, false)));
                  },
