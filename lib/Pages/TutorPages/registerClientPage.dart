            ...
            IconButton(
              ...
              onPressed: () {
                ...
                showModalBottomSheet(
                        context: context, builder: (_) => ContactListPage())
                    .then((value) => {
                          if (value != null)
                            {
                              contact = value,
                              phoneNumberTextField.text = contact.phones != null
                                  ? getFormattedMobileNo(
                                      contact.phones.first.value)
                                  : "",
                              nameTextField.text = contact.displayName != null
                                  ? contact.displayName
                                  : "",
