...
import 'package:chronicle/app_bar_variables.dart';
...
import 'package:chronicle/Widgets/register_option_bottom_sheet.dart';
...
import '../../Widgets/register_new_client_widget.dart';
...
class _ClientPageState extends State<ClientPage> {
  ...
  final TextEditingController renameRegisterTextEditingController =
      new TextEditingController();
  ...
  void searchOperation(String searchText) {
    ...
    if (_isSearching) {
      searchResult = clients
          .where((ClientModel element) => (element.masterFilter).contains(
          ...
          PopupMenuButton<ModalOptionModel>(
            itemBuilder: (BuildContext popupContext) {
              return [
                    ...
                    onTap: () async {
                      ...
                      showDialog(
                          ...
                          builder: (_) => new AlertDialog(
                                ...
                                content: TextField(
                                  controller:
                                      renameRegisterTextEditingController,
                                ...
                                actions: [
                                  ActionChip(
                                      label: Text("Rename"),
                                      onPressed: () {
                                        if (renameRegisterTextEditingController
                                                .text !=
                                            "") {
                                          setState(() {
                                            widget.register.name =
                                                renameRegisterTextEditingController
                                                    ...
                                                    .replaceAll(
                                                        new RegExp(r'[^\s\w]+'),
                                                        "");
                                            renameRegister(widget.register,
                                                widget.register.id);
                                            renameRegisterTextEditingController
                                                .clear();
                                            Navigator.of(_).pop();
                                            this.appBarTitle =
                                                AppBarVariables.appBarLeading(
                                                    widget.mainScreenContext);
                                          });
                                          globalShowInSnackBar(
                                              scaffoldMessengerKey,
                                              "Register Renamed to ${widget.register.name}!!");
                                        } else {
                                          globalShowInSnackBar(
                                              scaffoldMessengerKey,
                ...
                ModalOptionModel(
                    particulars: "Upload Client list",
        ...
        actions: <Widget>[
          ...
          IconButton(
            onPressed: () async {
              showModalBottomSheet(
                  context: widget.mainScreenContext,
                  builder: (_) => RegisterOptionBottomSheet(
                      isAddToRegister: true,
                      selectedClients: this.selectedList)).then((value) => {
            ...
            onPressed: () async {
              showDialog(
                  ...
                  builder: (_) => new AlertDialog(
                        ...
                        content: Text(
                            "Are you sure to delete all the selected clients?\n The change is irreversible."),
                        actions: [
                          ActionChip(
                              label: Text("Yes"),
                              onPressed: () {
    ...
    return ScaffoldMessenger(
      child: Scaffold(
              ...
              GestureDetector(
                onTap: () {
                  showModalBottomSheet(
                      context: widget.mainScreenContext,
                      builder: (_) =>
                          RegisterOptionBottomSheet(isAddToRegister: false));
                },
                child: Container(
                                                          ...
                                                          ActionChip(
                                                              ...
                                                              onPressed: () {
                                                                setState(() {
                                                                  ...
                                                                  globalShowInSnackBar(
                                                                      scaffoldMessengerKey,
                                                                      "Client Data ${searchResult[index].name} deleted!!");
                                                                  searchResult
                                                                      .removeAt(
                                                                          index);
                                                                  Navigator.of(
                                                          ...
                                                          ActionChip(
                                                              ...
                                                              onPressed: () {
                                                                setState(() {
                                                                  ...
                                                                  globalShowInSnackBar(
                                                                      scaffoldMessengerKey,
                                                                      "Client Data ${clients[index].name}, deleted!!");
                                                                  clients
                                                                      .removeAt(
                                                                          index);
                                                                  Navigator.of(
        ...
        floatingActionButton: (selectedList.length < 1)
            ? RegisterNewClientWidget(
                this.newClientModel, widget.mainScreenContext)
                            ...
                            content: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    labelText: "Message",
                                    helperText:
                                        "Type the message you want to be sent to the selected Clients",
                                    contentPadding: EdgeInsets.all(10.0),
                                  ),
                                )),
                            actions: [
                              ActionChip(
                                  label: Text("Send Sms using Default Sim"),
                                  onPressed: () {
                                    if (textEditingController.text != "") {
                                      ...
                                      showDialog(
                                          ...
                                          builder: (_) => new AlertDialog(
                                                ...
                                                content: Text(
                                                    "Are you sure to send the message to all the selected clients?"),
                                                actions: [
                                                  ActionChip(
                                                      label: Text("Yes"),
                                                      onPressed: () {
                                      ...
                                      globalShowInSnackBar(scaffoldMessengerKey,
                                          "You can't send null message to your clients.");
                                      Navigator.of(_).pop();
                                    }
                                  }),
                              ActionChip(
                                  label: Text("Send Sms using Sms Gateway"),
                                  onPressed: () {
                                    if (GlobalClass.userDetail.smsAccessToken !=
                                            null &&
