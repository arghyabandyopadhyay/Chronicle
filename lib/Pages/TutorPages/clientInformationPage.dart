...
class _ClientInformationPageState extends State<ClientInformationPage> {
        ...
        showDialog(
            ...
            builder: (BuildContext context1) {
              return new AlertDialog(
                ...
                content: Text(
                    "Are you sure to add new payment. Your old payments for ${widget.client.name} will be flushed?"),
                actions: [
                  ActionChip(
                      label: Text("Yes"),
                      onPressed: () {
                                ...
                                actions: [
                                  ActionChip(
                                      ...
                                      onPressed: () {
                                        ...
                                        updateClient(
                                            widget.client, widget.client.id);
                                        changesSavedModule(
  ...
  void initState() {
    ...
    phoneNumberTextField.text =
        widget.client.mobileNo != null ? widget.client.mobileNo : "";
    nameTextField.text = widget.client.name != null ? widget.client.name : "";
    dueTextField.text =
        widget.client.due != null ? widget.client.due.toString() : "";
    addressTextField.text =
        widget.client.address != null ? widget.client.address : "";
    fathersNameTextField.text =
        widget.client.fathersName != null ? widget.client.fathersName : "";
    educationTextField.text =
        widget.client.education != null ? widget.client.education : "";
    occupationTextField.text =
        widget.client.occupation != null ? widget.client.occupation : "";
    injuriesTextField.text =
        widget.client.injuries != null ? widget.client.injuries : "";
    registrationIdTextField.text = (this.widget.client.registrationId != null &&
            this.widget.client.registrationId != ""
        ? this.widget.client.registrationId
        : this.widget.client.id.key);
    heightTextField.text = widget.client.height != null
        ? widget.client.height.toStringAsFixed(2)
        : "";
    weightTextField.text = widget.client.weight != null
        ? widget.client.weight.toStringAsFixed(2)
        : "";
    sexDropDown = widget.client.sex;
    casteDropDown = widget.client.caste;
    startDateTemp =
        widget.client.startDate != null ? widget.client.startDate : today;
  ...
  Widget build(BuildContext context) {
    return ScaffoldMessenger(
      child: Scaffold(
        appBar: AppBar(
          title: Text(
            widget.client.name != null ? widget.client.name : "Client Profile",
          ),
          actions: [
            Center(
                child: Text(
              this.widget.client.due == 0
                  ? "Last Month  "
                  : ("${this.widget.client.due < 0 ? "Paid" : "Due"}: " +
                      (this.widget.client.due.abs() +
                              (this.widget.client.due < 0 ? 1 : 0))
                          .toString() +
                      "  "),
              style: TextStyle(
                  color: this.widget.client.due <= 0
                      ? this.widget.client.due == 0
            ...
            PopupMenuButton<ModalOptionModel>(
              itemBuilder: (BuildContext popupContext) {
                return [
                  ...
                  ModalOptionModel(
                      ...
                      onTap: () async {
                        ...
                        if (permissionStatus == PermissionStatus.granted) {
                          if (phoneNumberTextField.text.isNotEmpty &&
                              nameTextField.text.isNotEmpty) {
                            try {
                              Contact contact = Contact();
                              PostalAddress address =
                                  PostalAddress(label: "Home");
                              ...
                              globalShowInSnackBar(scaffoldMessengerKey,
                                  "${widget.client.name} added to your contacts!!");
                            } catch (E) {
                              globalShowInSnackBar(scaffoldMessengerKey,
                            ...
                            globalShowInSnackBar(scaffoldMessengerKey,
                                "Name and the mobile no cannot be empty");
                        } else {
                                        ...
                                        onTap: () {
                                          ...
                                          showDialog(
                                              ...
                                              builder: (_) => new AlertDialog(
                                                    ...
                                                    content: Text(
                                                        "Are you sure to send a reminder to ${widget.client.name}?"),
                                                    actions: [
                                                      ActionChip(
                                                          label: Text("Yes"),
                                                          onPressed: () {
                  ...
                  ModalOptionModel(
                      particulars: "Add Payment",
                      icon: Icons.payment,
                      onTap: () {
                        Navigator.pop(popupContext);
                        addPaymentModule(this.widget.client, context,
                            scaffoldMessengerKey, this);
                      }),
                  ModalOptionModel(
                      particulars: "Delete",
                      icon: Icons.delete,
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            ...
                            onPressed: () async {
                              if (phoneNumberTextField.text != null &&
                                  phoneNumberTextField.text != "") {
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          helperText:
                              "Old payments data will be flushed if this field is filled",
                          contentPadding:
                              EdgeInsets.only(left: 10.0, right: 10.0),
                        ),
                        keyboardType: TextInputType.number,
                        ...
                        onSaved: (value) {
                          try {
                            if (value.isNotEmpty) {
                              ...
                              if (widget.client.startDate == null)
                                widget.client.startDate = today;
                              widget.client.endDate = DateTime(
                                  widget.client.startDate.year,
                                  widget.client.startDate.month + months,
                                  widget.client.startDate.day);
                            }
                          } catch (E) {
                            globalShowInSnackBar(scaffoldMessengerKey,
