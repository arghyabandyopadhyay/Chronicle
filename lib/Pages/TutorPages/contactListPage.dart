...
class _ContactListPageState extends State<ContactListPage> {
  ...
  void searchOperation(String searchText) {
    searchResult.clear();
    if (_isSearching) {
      searchResult = _contacts
          .where((Contact element) => (element.displayName.toLowerCase())
              .contains(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            icon: Icon(_isSearching ? Icons.search : (Icons.contacts)),
          ),
          actions: [
            new IconButton(
                icon: icon,
                    ...
                    ? ListView.builder(
                        ...
                        itemBuilder: (BuildContext context1, int index) {
                          ...
                          return ListTile(
                            ...
                            subtitle: Text(phone != null && phone.length > 0
                                ? phone.first.value
                                : ""),
                          );
                        },
