                ...
                children: [
                  ...
                  Row(children: [
                    ...
                    Expanded(
                      child: TextFormField(
                        ...
                        onSaved: (value) {
                          if (value.isNotEmpty)
                            courseData.authorPrice = double.parse(value);
                        },
                      ),
                    ),
                  ]),
                  ...
                  Row(
                    children: [
                      ...
                      IconButton(
                        icon: Icon((this.courseData.previewVideo != null)
                          ...
                          showModalBottomSheet(
                            ...
                            if (value != null)
                              setState(() {
                                ...
                                courseData.previewThumbnailUrl =
                                    courseData.previewVideo.thumbnailUrl;
                              });
                          });
                        },
                      )
                  ...
                  if (this.courseData.previewVideo != null)
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          showModalBottomSheet(
                            ...
                            if (value != null)
                              setState(() {
                                if (this.courseData.videos != null)
                                  this.courseData.videos.addAll(value.toList());
                                else
                                  this.courseData.videos = value;
                              });
                          });
                        },
                      )
