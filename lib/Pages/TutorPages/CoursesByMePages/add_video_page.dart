...
class AddVideoPage extends StatefulWidget {
  final Function(String filePath, String thumnailFilePath, String name,
      String description, String masterFilter) callback;
...
class _AddVideoPageState extends State<AddVideoPage> {
  ...
  void _handleSubmitted() {
    ...
    if (!form.validate()) {
      if (fileTextField.text.isEmpty)
        globalShowInSnackBar(
            scaffoldMessengerKey, "Please upload a video to proceed!!");
    } else {
      form.save();
      widget.callback(
          fileTextField.text,
          thumbnailTextField.text,
          nameTextField.text.replaceAll(new RegExp(r'[^\s\w]+'), ""),
                  ...
                  Row(children: [
                    ...
                    if (thumbnailTextField.text.isEmpty)
                      IconButton(
                        ...
                        onPressed: () async {
                          thumbnailFile = await ImagePicker().getImage(
                            source: ImageSource.gallery,
                          );
                          setState(() {
