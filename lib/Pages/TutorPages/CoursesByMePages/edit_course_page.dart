...
import 'package:chronicle/Widgets/edit-course_video_list.dart';
...
class _EditCoursesPageState extends State<EditCoursesPage> {
  ...
  updateVideoDetails(VideoIndexModel videoIndexModel, int index) {
    setState(() {
      ...
      if (index != -3)
        this.courseDetail.videos[index] = videoIndexModel;
      else
        this.courseDetail.previewVideo = videoIndexModel;
    });
    globalShowInSnackBar(scaffoldMessengerKey,
        "Changes made to ${videoIndexModel.name} has been saved!!");
  }
          ...
          if (mounted)
            this.setState(() {
              ...
              monthsTextField.text =
                  courseDetail.coursePackageDurationInMonths.toString();
                            ...
                            child: TextFormField(
                              ...
                              validator: (value) {
                                if (value.isEmpty)
                                  ...
                                  return "Duration of the course in months  cant be 0!!";
                                else {
                                  try {
                              ...
                              onSaved: (value) {
                                try {
                                  int months = int.parse(value);
                                  months = months.abs();
                                  courseDetail.coursePackageDurationInMonths =
                                      months;
                                } catch (E) {
                                  globalShowInSnackBar(scaffoldMessengerKey,
                            ...
                            child: Container(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    helperText:
                                        "Type the description to your course",
                          ...
                          Expanded(
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                helperText:
                                    "This is the price that you charge for this course per enrollment. "
                          ...
                          EditCourseVideosList(
                            ...
                            onTapList: (index) {
                              Navigator.of(context).push(CupertinoPageRoute(
                                  builder: (editPageContext) => EditVideoPage(
                                      callback: this.updateVideoDetails,
                                      videoIndex:
                                          this.courseDetail.previewVideo,
                                      index: -3)));
                            },
                            ...
                            onTapList: (index) {
                              Navigator.of(context).push(CupertinoPageRoute(
                                  builder: (editPageContext) => EditVideoPage(
                                      callback: this.updateVideoDetails,
                                      videoIndex:
                                          this.courseDetail.videos[index],
                                      index: index)));
                            },
                            onButtonTapped: (index) {
                              setState(() {
                                this.courseDetail.deleteCourseVideoIndex(
                                    this.courseDetail.videos[index]);
                              });
                            },
                          ),
